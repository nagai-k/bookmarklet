...
(function(w) {
	...
	(function() {
		...
		var resultHTML = [
			...
			'#loading {padding:3em;text-align:center}',
			...
			'</head>',
			'<body>',
			'<div id="loading">now computing...<br>',
			'<img src="http://tkr.nsf.jp/tagcheck/loading.gif">',
			'</div>',
		...
		w.go = function(id) {
			...
			var half = w.innerHeight / 2;
			w.scrollBy(0, before > after ? -half : half);
		};
